...
HD_PWD='D:/tmp/CLEFIA/CLEFIA_128/dec/dec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_dec_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_dec_wrapper.tcl
