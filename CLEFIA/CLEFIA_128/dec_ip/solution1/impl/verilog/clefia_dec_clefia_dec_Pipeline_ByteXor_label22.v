...
wire   [63:0] zext_ln121_9_fu_127_p1;
reg   [63:0] reuse_addr_reg_fu_42;
wire    ap_loop_init;
reg   [7:0] reuse_reg_fu_46;
wire   [7:0] xor_ln124_1_fu_173_p2;
reg   [1:0] idx96_i_fu_50;
wire   [1:0] add_ln124_fu_132_p2;
wire   [7:0] zext_ln121_3_cast_fu_102_p3;
wire   [2:0] or_ln121_3_fu_115_p3;
wire  signed [3:0] sext_ln121_fu_123_p1;
    ...
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            reuse_addr_reg_fu_42[63] <= 1'b1;
                        ...
                        reuse_addr_reg_fu_42[1 : 0] <= zext_ln121_9_fu_127_p1[1 : 0];
            reuse_addr_reg_fu_42[63 : 4] <= zext_ln121_9_fu_127_p1[63 : 4];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        rin_addr_reg_211[1 : 0] <= zext_ln121_9_fu_127_p1[1 : 0];
    end
end
...
assign add_ln124_fu_132_p2 = (idx96_i_fu_50 + 2'd1);

assign addr_cmp_fu_141_p2 = ((reuse_addr_reg_fu_42 == zext_ln121_9_fu_127_p1) ? 1'b1 : 1'b0);
...
assign icmp_ln123_fu_152_p2 = ((idx96_i_fu_50 == 2'd3) ? 1'b1 : 1'b0);

assign or_ln121_3_fu_115_p3 = {{1'd1}, {idx96_i_fu_50}};

assign reuse_select_fu_166_p3 = ((addr_cmp_reg_217[0:0] == 1'b1) ? reuse_reg_fu_46 : rin_q1);

assign rin_address0 = rin_addr_reg_211;

assign rin_address1 = zext_ln121_9_fu_127_p1;

assign rin_d0 = (rk_q0 ^ reuse_select_fu_166_p3);

assign rk_address0 = zext_ln121_fu_110_p1;

assign sext_ln121_fu_123_p1 = $signed(or_ln121_3_fu_115_p3);

assign xor_ln124_1_fu_173_p2 = (rk_q0 ^ reuse_select_fu_166_p3);

assign zext_ln121_3_cast_fu_102_p3 = {{6'd39}, {idx96_i_fu_50}};

assign zext_ln121_9_fu_127_p1 = $unsigned(sext_ln121_fu_123_p1);

assign zext_ln121_fu_110_p1 = zext_ln121_3_cast_fu_102_p3;

always @ (posedge ap_clk) begin
    rin_addr_reg_211[3:2] <= 2'b11;
