...
module clefia_dec_clefia_dec_Pipeline_ByteXor_label2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln123_fu_148_p2;
reg    ap_condition_exit_pp0_iter1_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire    ap_block_pp0_stage0_11001;
reg   [3:0] rin_addr_reg_207;
wire   [0:0] addr_cmp_fu_137_p2;
reg   [0:0] addr_cmp_reg_213;
wire   [63:0] zext_ln121_fu_110_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln121_10_fu_123_p1;
reg   [63:0] reuse_addr_reg_fu_42;
wire    ap_loop_init;
reg   [7:0] reuse_reg_fu_46;
wire   [7:0] xor_ln124_fu_169_p2;
reg   [1:0] idx92_i_fu_50;
wire   [1:0] add_ln124_fu_128_p2;
wire   [7:0] zext_ln121_cast_fu_102_p3;
wire   [2:0] zext_ln121_1_cast_fu_115_p3;
wire   [7:0] reuse_select_fu_162_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            idx92_i_fu_50 <= 2'd0;
        end else if (((icmp_ln123_fu_148_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
    ...
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            reuse_addr_reg_fu_42[63] <= 1'b1;
                        ...
                        reuse_addr_reg_fu_42[1 : 0] <= zext_ln121_10_fu_123_p1[1 : 0];
            reuse_addr_reg_fu_42[63 : 3] <= zext_ln121_10_fu_123_p1[63 : 3];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        rin_addr_reg_207[1 : 0] <= zext_ln121_10_fu_123_p1[1 : 0];
    end
end

always @ (*) begin
    if (((icmp_ln123_fu_148_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln124_fu_128_p2 = (idx92_i_fu_50 + 2'd1);

assign addr_cmp_fu_137_p2 = ((reuse_addr_reg_fu_42 == zext_ln121_10_fu_123_p1) ? 1'b1 : 1'b0);
...
assign icmp_ln123_fu_148_p2 = ((idx92_i_fu_50 == 2'd3) ? 1'b1 : 1'b0);

assign reuse_select_fu_162_p3 = ((addr_cmp_reg_213[0:0] == 1'b1) ? reuse_reg_fu_46 : rin_q1);

assign rin_address0 = rin_addr_reg_207;

assign rin_address1 = zext_ln121_10_fu_123_p1;

assign rin_d0 = (rk_q0 ^ reuse_select_fu_162_p3);

assign rk_address0 = zext_ln121_fu_110_p1;

assign xor_ln124_fu_169_p2 = (rk_q0 ^ reuse_select_fu_162_p3);

assign zext_ln121_10_fu_123_p1 = zext_ln121_1_cast_fu_115_p3;

assign zext_ln121_1_cast_fu_115_p3 = {{1'd1}, {idx92_i_fu_50}};

assign zext_ln121_cast_fu_102_p3 = {{6'd38}, {idx92_i_fu_50}};

assign zext_ln121_fu_110_p1 = zext_ln121_cast_fu_102_p3;

always @ (posedge ap_clk) begin
    rin_addr_reg_207[3:2] <= 2'b01;
    reuse_addr_reg_fu_42[2] <= 1'b1;
end

endmodule //clefia_dec_clefia_dec_Pipeline_ByteXor_label2
