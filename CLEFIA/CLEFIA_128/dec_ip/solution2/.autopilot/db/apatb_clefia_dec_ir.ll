; ModuleID = 'D:/tmp/CLEFIA/CLEFIA_128/dec_ip/solution2/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline
define void @apatb_clefia_dec_ir(i8* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" %ct, i8* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="32" %skey, i8* noalias nocapture nonnull "fpga.decayed.dim.hint"="16" %pt) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in([16 x i8]* nonnull %0, [16 x i8]* nonnull align 512 %ct_copy, [32 x i8]* nonnull %1, [32 x i8]* nonnull align 512 %skey_copy, [16 x i8]* nonnull %2, [16 x i8]* nonnull align 512 %pt_copy)
  ...
  call void @apatb_clefia_dec_hw(i8* %3, i8* %4, i8* %5)
  call void @copy_back([16 x i8]* %0, [16 x i8]* %ct_copy, [32 x i8]* %1, [32 x i8]* %skey_copy, [16 x i8]* %2, [16 x i8]* %pt_copy)
  ret void
}
...
declare void @apatb_clefia_dec_hw(i8*, i8*, i8*)
...
define void @clefia_dec_hw_stub_wrapper(i8*, i8*, i8*) #4 {
entry:
