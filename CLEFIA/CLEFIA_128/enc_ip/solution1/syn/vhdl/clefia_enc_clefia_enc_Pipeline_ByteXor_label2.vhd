...
entity clefia_enc_clefia_enc_Pipeline_ByteXor_label2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of clefia_enc_clefia_enc_Pipeline_ByteXor_label2 is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln116_fu_136_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln114_fu_98_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln114_10_fu_111_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal reuse_addr_reg_fu_38 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal reuse_reg_fu_42 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln117_fu_157_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal idx93_i_fu_46 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln117_fu_116_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal zext_ln114_1_cast_fu_103_p3 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    idx93_i_fu_46_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    idx93_i_fu_46 <= ap_const_lv2_0;
                elsif (((icmp_ln116_fu_136_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                    idx93_i_fu_46 <= add_ln117_fu_116_p2;
                end if;
            end if; 
        end if;
    end process;
            ...
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    reuse_addr_reg_fu_38(63) <= '1';
                                        ...
                                        reuse_addr_reg_fu_38(1 downto 0) <= zext_ln114_10_fu_111_p1(1 downto 0);                    reuse_addr_reg_fu_38(63 downto 3) <= zext_ln114_10_fu_111_p1(63 downto 3);
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ...
                    reuse_reg_fu_42 <= xor_ln117_fu_157_p2;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                addr_cmp_reg_201 <= addr_cmp_fu_125_p2;
                    rin_addr_reg_195(1 downto 0) <= zext_ln114_10_fu_111_p1(4 - 1 downto 0)(1 downto 0);
            end if;
        end if;
    end process;
    ...
    add_ln117_fu_116_p2 <= std_logic_vector(unsigned(idx93_i_fu_46) + unsigned(ap_const_lv2_1));
    addr_cmp_fu_125_p2 <= "1" when (reuse_addr_reg_fu_38 = zext_ln114_10_fu_111_p1) else "0";
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, icmp_ln116_fu_136_p2)
    begin
        if (((icmp_ln116_fu_136_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln116_fu_136_p2 <= "1" when (idx93_i_fu_46 = ap_const_lv2_3) else "0";
    reuse_select_fu_150_p3 <= 
        reuse_reg_fu_42 when (addr_cmp_reg_201(0) = '1') else 
        rin_q1;
    rin_address0 <= rin_addr_reg_195;
    rin_address1 <= zext_ln114_10_fu_111_p1(4 - 1 downto 0);
    ...
    rk_address0 <= zext_ln114_fu_98_p1(8 - 1 downto 0);
    ...
    xor_ln117_fu_157_p2 <= (rk_q0 xor reuse_select_fu_150_p3);
    zext_ln114_10_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln114_1_cast_fu_103_p3),64));
    zext_ln114_1_cast_fu_103_p3 <= (ap_const_lv1_1 & idx93_i_fu_46);
    zext_ln114_fu_98_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(idx93_i_fu_46),64));
end behav;
