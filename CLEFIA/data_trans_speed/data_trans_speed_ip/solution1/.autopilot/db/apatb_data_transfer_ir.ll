; ModuleID = 'D:/tmp/CLEFIA/data_trans_speed/data_trans_speed_ip/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline
define void @apatb_data_transfer_ir(i8* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" %pt, i8* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="32" %skey, i8* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" %ct) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_data_transfer_hw(i8* %3, i8* %4, i8* %5)
...
declare void @apatb_data_transfer_hw(i8*, i8*, i8*)
...
define void @data_transfer_hw_stub_wrapper(i8*, i8*, i8*) #4 {
entry:
  ...
  call void @data_transfer_hw_stub(i8* %6, i8* %7, i8* %8)
  call void @copy_in([16 x i8]* null, [16 x i8]* %3, [32 x i8]* null, [32 x i8]* %4, [16 x i8]* null, [16 x i8]* %5)
  ret void
}

declare void @data_transfer_hw_stub(i8*, i8*, i8*)
