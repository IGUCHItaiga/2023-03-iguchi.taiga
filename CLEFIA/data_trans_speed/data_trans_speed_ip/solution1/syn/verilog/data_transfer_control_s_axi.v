...
// ==============================================================
`timescale 1ns/1ps
module data_transfer_control_s_axi
#(parameter
...
//------------------------Local signal-------------------
    ...
    wire                          int_skey_ce0;
    wire [3:0]                    int_skey_be0;
    wire [31:0]                   int_skey_d0;
...
//------------------------Instantiation------------------
// int_pt
data_transfer_control_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "T2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 4 )
...
module data_transfer_control_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
