...
// ==============================================================
`timescale 1 ns / 1 ps
module clefia_dec_clefia_s0_ROM_AUTO_1R (
...
initial begin
    $readmemh("./clefia_dec_clefia_s0_ROM_AUTO_1R.dat", ram0);
    $readmemh("./clefia_dec_clefia_s0_ROM_AUTO_1R.dat", ram1);
    $readmemh("./clefia_dec_clefia_s0_ROM_AUTO_1R.dat", ram2);
    $readmemh("./clefia_dec_clefia_s0_ROM_AUTO_1R.dat", ram3);
end
