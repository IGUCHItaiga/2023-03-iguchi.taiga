...
HD_PWD='D:/tmp/CLEFIA/CLEFIA_192/enc/enc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_enc_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_enc_wrapper.tcl -notrace
