...
set ID 9
set hasByteEnable 0
set MemName clefia_enc_clefia_enc_Pipeline_ClefiaGfn4_label3_clefia_s0_ROM_AUTO_1R
...
set ID 10
set hasByteEnable 0
set MemName clefia_enc_clefia_enc_Pipeline_ClefiaGfn4_label3_clefia_s1_ROM_AUTO_1R
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 256
...
set InstName clefia_enc_flow_control_loop_pipe_sequential_init_U
set CompName clefia_enc_flow_control_loop_pipe_sequential_init
