...
HD_PWD='D:/tmp/CLEFIA/CLEFIA_256/enc/enc.runs/design_enc_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_enc_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_enc_processing_system7_0_0.tcl
