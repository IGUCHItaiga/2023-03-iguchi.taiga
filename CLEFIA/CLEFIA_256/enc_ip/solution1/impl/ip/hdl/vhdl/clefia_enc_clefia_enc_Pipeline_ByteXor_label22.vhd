...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    idx97_i_fu_46 <= add_ln124_fu_120_p2;
                end if;
            end if; 
        end if;
    end process;
            ...
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    reuse_addr_reg_fu_38(63) <= '1';
                                        ...
                                        reuse_addr_reg_fu_38(1 downto 0) <= zext_ln121_9_fu_115_p1(1 downto 0);                    reuse_addr_reg_fu_38(63 downto 4) <= zext_ln121_9_fu_115_p1(63 downto 4);
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
                    ...
                    reuse_reg_fu_42 <= xor_ln124_1_fu_161_p2;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                addr_cmp_reg_205 <= addr_cmp_fu_129_p2;
                    rin_addr_reg_199(1 downto 0) <= zext_ln121_9_fu_115_p1(4 - 1 downto 0)(1 downto 0);
            end if;
        end if;
    end process;
    ...
    add_ln124_fu_120_p2 <= std_logic_vector(unsigned(idx97_i_fu_46) + unsigned(ap_const_lv2_1));
    addr_cmp_fu_129_p2 <= "1" when (reuse_addr_reg_fu_38 = zext_ln121_9_fu_115_p1) else "0";
    ...
    icmp_ln123_fu_140_p2 <= "1" when (idx97_i_fu_46 = ap_const_lv2_3) else "0";
    reuse_select_fu_154_p3 <= 
        reuse_reg_fu_42 when (addr_cmp_reg_205(0) = '1') else 
        rin_q1;
    rin_address0 <= rin_addr_reg_199;
    rin_address1 <= zext_ln121_9_fu_115_p1(4 - 1 downto 0);
    ...
    begin
        ...
        sext_ln121_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(zext_ln121_2_cast_fu_98_p3),4));

    xor_ln124_1_fu_161_p2 <= (rk_q0 xor reuse_select_fu_154_p3);
    zext_ln121_2_cast_fu_98_p3 <= (ap_const_lv1_1 & idx97_i_fu_46);
    zext_ln121_9_fu_115_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sext_ln121_fu_111_p1),64));
    zext_ln121_fu_106_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln121_2_cast_fu_98_p3),64));
end behav;
