...
wire   [63:0] zext_ln121_10_fu_111_p1;
...
wire   [2:0] zext_ln121_1_cast_fu_103_p3;
    ...
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            reuse_addr_reg_fu_38[63] <= 1'b1;
                        ...
                        reuse_addr_reg_fu_38[1 : 0] <= zext_ln121_10_fu_111_p1[1 : 0];
            reuse_addr_reg_fu_38[63 : 3] <= zext_ln121_10_fu_111_p1[63 : 3];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        rin_addr_reg_195[1 : 0] <= zext_ln121_10_fu_111_p1[1 : 0];
    end
end
...
assign add_ln124_fu_116_p2 = (idx93_i_fu_46 + 2'd1);

assign addr_cmp_fu_125_p2 = ((reuse_addr_reg_fu_38 == zext_ln121_10_fu_111_p1) ? 1'b1 : 1'b0);
...
assign zext_ln121_10_fu_111_p1 = zext_ln121_1_cast_fu_103_p3;

assign zext_ln121_1_cast_fu_103_p3 = {{1'd1}, {idx93_i_fu_46}};

assign zext_ln121_fu_98_p1 = idx93_i_fu_46;
