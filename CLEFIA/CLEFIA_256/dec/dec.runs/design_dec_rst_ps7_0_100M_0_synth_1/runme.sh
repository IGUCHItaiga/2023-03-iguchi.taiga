...
HD_PWD='D:/tmp/CLEFIA/CLEFIA_256/dec/dec.runs/design_dec_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_dec_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_dec_rst_ps7_0_100M_0.tcl
