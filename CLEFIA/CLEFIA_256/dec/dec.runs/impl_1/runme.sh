...
HD_PWD='D:/tmp/CLEFIA/CLEFIA_256/dec/dec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_dec_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_dec_wrapper.tcl -notrace
