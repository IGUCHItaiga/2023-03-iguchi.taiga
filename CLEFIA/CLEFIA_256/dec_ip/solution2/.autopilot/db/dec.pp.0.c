...
void ClefiaKeySet256(unsigned char *rk, const unsigned char *skey)
{
#line 11 "D:/tmp/CLEFIA/CLEFIA_256/dec_ip/solution2/directives.tcl"
...
void ClefiaDecrypt(unsigned char *pt, const unsigned char *ct, const unsigned char *rk, const int r)
{
#line 12 "D:/tmp/CLEFIA/CLEFIA_256/dec_ip/solution2/directives.tcl"
#pragma HLSDIRECTIVE PIPELINE
# 312 "src/dec.c"
...
__attribute__((sdx_kernel("clefia_dec", 0))) void clefia_dec(const unsigned char ct[16], const unsigned char skey[32], unsigned char pt[16])
{
#line 10 "D:/tmp/CLEFIA/CLEFIA_256/dec_ip/solution2/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=pt
# 336 "src/dec.c"

#line 13 "D:/tmp/CLEFIA/CLEFIA_256/dec_ip/solution2/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=skey
# 336 "src/dec.c"

#line 15 "D:/tmp/CLEFIA/CLEFIA_256/dec_ip/solution2/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=clefia_dec
# 336 "src/dec.c"

#line 6 "D:/tmp/CLEFIA/CLEFIA_256/dec_ip/solution2/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=return
# 336 "src/dec.c"

#line 7 "D:/tmp/CLEFIA/CLEFIA_256/dec_ip/solution2/directives.tcl"
#pragma HLSDIRECTIVE INLINE recursive
# 336 "src/dec.c"

#line 8 "D:/tmp/CLEFIA/CLEFIA_256/dec_ip/solution2/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=ct
# 336 "src/dec.c"

#line 9 "D:/tmp/CLEFIA/CLEFIA_256/dec_ip/solution2/directives.tcl"
#pragma HLSDIRECTIVE TOP name=clefia_dec
# 336 "src/dec.c"
