...
set solution_dir "D:/tmp/CLEFIA/CLEFIA_256/dec_ip/solution2"
set debug_dir "D:/tmp/CLEFIA/CLEFIA_256/dec_ip/solution2/.debug"
set xo_hls_files_dir ""
set hdl_module_list {clefia_dec_clefia_s0_ROM_AUTO_1R
...
set Interfaces {
    s_axi_control {
        ...
        memories "ct {base_address 16 range 16} skey {base_address 32 range 32} pt {base_address 64 range 16}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 205 II x}
