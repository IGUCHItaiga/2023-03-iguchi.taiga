...
// ==============================================================
`timescale 1ns/1ps
module clefia_dec_control_s_axi
#(parameter
...
assign RVALID  = (rstate == RDDATA) & !int_ct_read & !int_pt_read;
...
assign ct_q0           = int_ct_q0 >> (int_ct_shift0 * 8);
...
module clefia_dec_control_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
