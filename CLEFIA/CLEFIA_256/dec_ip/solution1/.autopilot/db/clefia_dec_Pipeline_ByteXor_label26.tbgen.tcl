set moduleName clefia_dec_Pipeline_ByteXor_label26
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {clefia_dec_Pipeline_ByteXor_label26}
set C_modelType { void 0 }
set C_modelArgList {
	{ pt int 8 regular {array 16 { 2 } 1 1 }  }
	{ rk int 8 regular {array 224 { 1 } 1 1 } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "pt", "interface" : "memory", "bitwidth" : 8, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ pt_address0 sc_out sc_lv 4 signal 0 } 
	{ pt_ce0 sc_out sc_logic 1 signal 0 } 
	{ pt_we0 sc_out sc_logic 1 signal 0 } 
	{ pt_d0 sc_out sc_lv 8 signal 0 } 
	{ pt_q0 sc_in sc_lv 8 signal 0 } 
...
set Spec2ImplPortList { 
	pt { ap_memory {  { pt_address0 mem_address 1 4 }  { pt_ce0 mem_ce 1 1 }  { pt_we0 mem_we 1 1 }  { pt_d0 mem_din 1 8 }  { pt_q0 in_data 0 8 } } }
