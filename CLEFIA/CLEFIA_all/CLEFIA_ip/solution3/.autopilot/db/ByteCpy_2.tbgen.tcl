...
set Spec2ImplPortList { 
	...
	src { ap_memory {  { src_address0 mem_address 1 4 }  { src_ce0 mem_ce 1 1 }  { src_q0 mem_dout 0 8 }  { src_address1 MemPortADDR2 1 4 }  { src_ce1 MemPortCE2 1 1 }  { src_q1 in_data 0 8 } } }
}
