...
set portList { 
	...
	{ src_address0 sc_out sc_lv 4 signal 2 } 
	{ src_ce0 sc_out sc_logic 1 signal 2 } 
	{ src_q0 sc_in sc_lv 8 signal 2 } 
	{ src_offset sc_in sc_lv 4 signal 3 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "9", "Max" : "25"}
	, {"Name" : "Interval", "Min" : "9", "Max" : "25"}
]}
