...
set hasInterrupt 0
set C_modelName {ByteXor.112.2}
set C_modelType { void 0 }
set C_modelArgList {
	{ a int 8 regular {array 16 { 2 3 } 1 1 }  }
	{ a_offset int 4 regular  }
	{ b int 8 regular {array 224 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ b_offset sc_in sc_lv 8 signal 3 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	a { ap_memory {  { a_address0 mem_address 1 4 }  { a_ce0 mem_ce 1 1 }  { a_we0 mem_we 1 1 }  { a_d0 mem_din 1 8 }  { a_q0 in_data 0 8 } } }
