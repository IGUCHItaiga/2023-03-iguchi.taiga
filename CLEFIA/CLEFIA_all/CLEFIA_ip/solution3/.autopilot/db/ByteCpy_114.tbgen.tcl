...
set portList { 
	...
	{ bytelen_offset_offset sc_in sc_lv 6 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bytelen_offset_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "bytelen_offset_offset", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "49", "Max" : "65"}
	, {"Name" : "Interval", "Min" : "49", "Max" : "65"}
]}
...
set Spec2ImplPortList { 
	...
	src { ap_memory {  { src_address0 mem_address 1 5 }  { src_ce0 mem_ce 1 1 }  { src_q0 in_data 0 8 } } }
	bytelen_offset_offset { ap_none {  { bytelen_offset_offset in_data 0 6 } } }
}
