...
void ByteCpy(unsigned char *dst, const unsigned char *src, int bytelen)
{
#line 20 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE INLINE off
# 115 "clefia.c"

  ByteCpy_label1:while(bytelen-- > 0){
#line 18 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
...
void ByteXor(unsigned char *dst, const unsigned char *a, const unsigned char *b, int bytelen)
{
#line 21 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE INLINE off
# 122 "clefia.c"

  ByteXor_label2:while(bytelen-- > 0){
#line 17 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE PIPELINE off
# 123 "clefia.c"
...
unsigned char ClefiaMul2(unsigned char x)
{
#line 23 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE INLINE recursive off
# 129 "clefia.c"
...
{
#line 24 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE PIPELINE off
# 143 "clefia.c"
...
{
#line 25 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE PIPELINE off
# 166 "clefia.c"
...
#line 26 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
...
#line 27 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE UNROLL
# 210 "clefia.c"
...
#line 16 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE UNROLL
# 230 "clefia.c"
...
#line 15 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE UNROLL
# 273 "clefia.c"
...
void ClefiaKeySet128(unsigned char *rk, const unsigned char *skey)
{
  const unsigned char iv[2] = {0x42U, 0x8aU};
  unsigned char lk[16];
  ...
  ByteCpy(rk, skey, 8);
  rk += 8;
  ClefiaKeySet128_label7:for(i = 0; i < 9; i++){
#line 14 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE UNROLL
# 309 "clefia.c"

    ByteXor(rk, lk, con128 + i * 16 + (4 * 24), 16);
    if(i % 2){
      ByteXor(rk, rk, skey, 16);
    }
    ClefiaDoubleSwap(lk);
    rk += 16;
  }
...
#line 12 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE UNROLL
# 329 "clefia.c"
...
#line 13 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE UNROLL
# 340 "clefia.c"
...
void ClefiaKeySet256(unsigned char *rk, const unsigned char *skey)
{
  const unsigned char iv[2] = {0xb5, 0xc0U};
  unsigned char lk[32];
  ...
  rk += 8;
  ClefiaKeySet256_label10:for(i = 0; i < 13; i++){
#line 11 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE UNROLL
# 373 "clefia.c"

    if((i / 2) % 2){
      ByteXor(rk, lk + 16, con256 + i * 16 + (4 * 40), 16);
      if(i % 2){
        ByteXor(rk, rk, skey + 0, 16);
      }
      ClefiaDoubleSwap(lk + 16);
    }else{
      ByteXor(rk, lk + 0, con256 + i * 16 + (4 * 40), 16);
      if(i % 2){
        ByteXor(rk, rk, skey + 16, 16);
      }
      ClefiaDoubleSwap(lk + 0);
    }
    rk += 16;
...
void ClefiaDecrypt(unsigned char *pt, const unsigned char *ct, const unsigned char *rk, const int r)
{
  ...
  ByteXor(rin + 4, rin + 4, rk + r * 8 + 8, 4);
  ByteXor(rin + 12, rin + 12, rk + r * 8 + 12, 4);
  rk += 8;

  ClefiaGfn4Inv(rout, rin, rk, r);

  ByteCpy(pt, rout, 16);
  ByteXor(pt + 4, pt + 4, rk - 8, 4);
...
__attribute__((sdx_kernel("clefia", 0))) void clefia(const unsigned char pt[16], int key_bitlen, unsigned char Clefia_enc[16], unsigned char Clefia_dec[16])
{
#line 10 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=Clefia_dec
# 451 "clefia.c"

#line 15 "D:/tmp/CLEFIA_ip/solution3/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=clefia
# 451 "clefia.c"

#line 19 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE TOP name=clefia
# 451 "clefia.c"

#line 22 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE PIPELINE
# 451 "clefia.c"

#line 6 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=return
# 451 "clefia.c"

#line 7 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=key_bitlen
# 451 "clefia.c"

#line 8 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=pt
# 451 "clefia.c"

#line 9 "D:/tmp/CLEFIA_ip/solution3/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=Clefia_enc
# 451 "clefia.c"
  ...
  r = ClefiaKeySet(rk, skey, key_bitlen);
  ClefiaEncrypt(Clefia_enc, pt, rk, r);


  ByteCpy(ct, Clefia_enc, 16);
  r = ClefiaKeySet(rk, skey, key_bitlen);
  ClefiaDecrypt(Clefia_dec, ct, rk, r);
