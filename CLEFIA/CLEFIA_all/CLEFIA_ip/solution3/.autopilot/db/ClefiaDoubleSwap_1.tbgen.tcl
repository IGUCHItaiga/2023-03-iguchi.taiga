...
set C_modelArgList {
	{ lk int 8 regular {array 32 { 2 1 } 1 1 }  }
	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"],
		...
		"Port" : [
			{"Name" : "lk", "Type" : "Memory", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_ByteCpy_117_fu_366", "Port" : "dst", "Inst_start_state" : "11", "Inst_end_state" : "12"}]},
			{"Name" : "lk_offset", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.t_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_ByteCpy_117_fu_366", "Parent" : "0",
		"CDFG" : "ByteCpy_117",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set Spec2ImplPortList { 
	lk { ap_memory {  { lk_address0 mem_address 1 5 }  { lk_ce0 mem_ce 1 1 }  { lk_we0 mem_we 1 1 }  { lk_d0 mem_din 1 8 }  { lk_q0 in_data 0 8 }  { lk_address1 MemPortADDR2 1 5 }  { lk_ce1 MemPortCE2 1 1 }  { lk_q1 in_data 0 8 } } }
