set moduleName ClefiaDecrypt_1_Pipeline_ClefiaGfn4Inv_label5
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {ClefiaDecrypt.1_Pipeline_ClefiaGfn4Inv_label5}
set C_modelType { void 0 }
set C_modelArgList {
	{ rin_44 int 8 regular  }
	{ rin_43 int 8 regular  }
	{ rin_42 int 8 regular  }
	{ rin_41 int 8 regular  }
	{ p_read11 int 8 regular  }
	{ p_read10 int 8 regular  }
	{ p_read9 int 8 regular  }
	{ p_read8 int 8 regular  }
	{ rin_40 int 8 regular  }
	{ rin_39 int 8 regular  }
	{ rin_38 int 8 regular  }
	{ rin int 8 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "rin_44", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "rin_43", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "rin_42", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "rin_41", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "rin_40", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "rin_39", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	{ "Name" : "rin_38", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ rin_44 sc_in sc_lv 8 signal 0 } 
	{ rin_43 sc_in sc_lv 8 signal 1 } 
	{ rin_42 sc_in sc_lv 8 signal 2 } 
	{ rin_41 sc_in sc_lv 8 signal 3 } 
	{ p_read11 sc_in sc_lv 8 signal 4 } 
	{ p_read10 sc_in sc_lv 8 signal 5 } 
	{ p_read9 sc_in sc_lv 8 signal 6 } 
	{ p_read8 sc_in sc_lv 8 signal 7 } 
	{ rin_40 sc_in sc_lv 8 signal 8 } 
	{ rin_39 sc_in sc_lv 8 signal 9 } 
	{ rin_38 sc_in sc_lv 8 signal 10 } 
	{ rin sc_in sc_lv 8 signal 11 } 
	{ p_read3 sc_in sc_lv 8 signal 12 } 
	{ p_read2 sc_in sc_lv 8 signal 13 } 
	{ p_read1 sc_in sc_lv 8 signal 14 } 
	{ p_read sc_in sc_lv 8 signal 15 } 
	{ r_cast2 sc_in sc_lv 5 signal 16 } 
	{ shl_ln sc_in sc_lv 8 signal 17 } 
	{ rk_address0 sc_out sc_lv 8 signal 18 } 
	{ rk_ce0 sc_out sc_logic 1 signal 18 } 
	{ rk_q0 sc_in sc_lv 8 signal 18 } 
	{ rk_address1 sc_out sc_lv 8 signal 18 } 
	{ rk_ce1 sc_out sc_logic 1 signal 18 } 
	{ rk_q1 sc_in sc_lv 8 signal 18 } 
	{ fin_4_out sc_out sc_lv 8 signal 19 } 
	{ fin_4_out_ap_vld sc_out sc_logic 1 outvld 19 } 
	{ fin_5_out sc_out sc_lv 8 signal 20 } 
	{ fin_5_out_ap_vld sc_out sc_logic 1 outvld 20 } 
	{ fin_6_out sc_out sc_lv 8 signal 21 } 
	{ fin_6_out_ap_vld sc_out sc_logic 1 outvld 21 } 
	{ fin_7_out sc_out sc_lv 8 signal 22 } 
	{ fin_7_out_ap_vld sc_out sc_logic 1 outvld 22 } 
	{ fin_8_out sc_out sc_lv 8 signal 23 } 
	{ fin_8_out_ap_vld sc_out sc_logic 1 outvld 23 } 
	{ fin_9_out sc_out sc_lv 8 signal 24 } 
	{ fin_9_out_ap_vld sc_out sc_logic 1 outvld 24 } 
	{ fin_10_out sc_out sc_lv 8 signal 25 } 
	{ fin_10_out_ap_vld sc_out sc_logic 1 outvld 25 } 
	{ fin_11_out sc_out sc_lv 8 signal 26 } 
	{ fin_11_out_ap_vld sc_out sc_logic 1 outvld 26 } 
	{ fin_12_out sc_out sc_lv 8 signal 27 } 
	{ fin_12_out_ap_vld sc_out sc_logic 1 outvld 27 } 
	{ fin_13_out sc_out sc_lv 8 signal 28 } 
	{ fin_13_out_ap_vld sc_out sc_logic 1 outvld 28 } 
	{ fin_14_out sc_out sc_lv 8 signal 29 } 
	{ fin_14_out_ap_vld sc_out sc_logic 1 outvld 29 } 
	{ fin_15_out sc_out sc_lv 8 signal 30 } 
	{ fin_15_out_ap_vld sc_out sc_logic 1 outvld 30 } 
	{ fin_0_out sc_out sc_lv 8 signal 31 } 
	{ fin_0_out_ap_vld sc_out sc_logic 1 outvld 31 } 
	{ fin_1_out sc_out sc_lv 8 signal 32 } 
	{ fin_1_out_ap_vld sc_out sc_logic 1 outvld 32 } 
	{ fin_2_out sc_out sc_lv 8 signal 33 } 
	{ fin_2_out_ap_vld sc_out sc_logic 1 outvld 33 } 
	{ fin_3_out sc_out sc_lv 8 signal 34 } 
	{ fin_3_out_ap_vld sc_out sc_logic 1 outvld 34 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "rin_44", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rin_44", "role": "default" }} , 
 	{ "name": "rin_43", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rin_43", "role": "default" }} , 
 	{ "name": "rin_42", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rin_42", "role": "default" }} , 
 	{ "name": "rin_41", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rin_41", "role": "default" }} , 
 	...
 	{ "name": "rin_40", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rin_40", "role": "default" }} , 
 	{ "name": "rin_39", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rin_39", "role": "default" }} , 
 	{ "name": "rin_38", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "rin_38", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "4", "7"],
		...
		"Port" : [
			...
			{"Name" : "rk", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_ClefiaF0Xor_fu_404", "Port" : "rk", "Inst_start_state" : "2", "Inst_end_state" : "6"},
					{"ID" : "4", "SubInstance" : "grp_ClefiaF1Xor_3_fu_423", "Port" : "rk", "Inst_start_state" : "7", "Inst_end_state" : "12"}]},
			...
			{"Name" : "clefia_s0", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_ClefiaF0Xor_fu_404", "Port" : "clefia_s0", "Inst_start_state" : "2", "Inst_end_state" : "6"},
					{"ID" : "4", "SubInstance" : "grp_ClefiaF1Xor_3_fu_423", "Port" : "clefia_s0", "Inst_start_state" : "7", "Inst_end_state" : "12"}]},
			{"Name" : "clefia_s1", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_ClefiaF0Xor_fu_404", "Port" : "clefia_s1", "Inst_start_state" : "2", "Inst_end_state" : "6"},
					{"ID" : "4", "SubInstance" : "grp_ClefiaF1Xor_3_fu_423", "Port" : "clefia_s1", "Inst_start_state" : "7", "Inst_end_state" : "12"}]}],
		"Loop" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_ClefiaF0Xor_fu_404", "Parent" : "0", "Child" : ["2", "3"],
		"CDFG" : "ClefiaF0Xor",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		...
		"Port" : [
			...
			{"Name" : "clefia_s0", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "clefia_s1", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ClefiaF0Xor_fu_404.clefia_s0_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ClefiaF0Xor_fu_404.clefia_s1_U", "Parent" : "1"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_ClefiaF1Xor_3_fu_423", "Parent" : "0", "Child" : ["5", "6"],
		"CDFG" : "ClefiaF1Xor_3",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "Aligned", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "clefia_s1", "Type" : "Memory", "Direction" : "I"},
			{"Name" : "clefia_s0", "Type" : "Memory", "Direction" : "I"}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ClefiaF1Xor_3_fu_423.clefia_s1_U", "Parent" : "4"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ClefiaF1Xor_3_fu_423.clefia_s0_U", "Parent" : "4"},
...
set Spec2ImplPortList { 
	rin_44 { ap_none {  { rin_44 in_data 0 8 } } }
	rin_43 { ap_none {  { rin_43 in_data 0 8 } } }
	rin_42 { ap_none {  { rin_42 in_data 0 8 } } }
	rin_41 { ap_none {  { rin_41 in_data 0 8 } } }
	...
	rin_40 { ap_none {  { rin_40 in_data 0 8 } } }
	rin_39 { ap_none {  { rin_39 in_data 0 8 } } }
	rin_38 { ap_none {  { rin_38 in_data 0 8 } } }
