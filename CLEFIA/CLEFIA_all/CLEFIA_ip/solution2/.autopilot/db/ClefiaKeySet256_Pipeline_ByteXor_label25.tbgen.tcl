set moduleName ClefiaKeySet256_Pipeline_ByteXor_label25
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {ClefiaKeySet256_Pipeline_ByteXor_label25}
set C_modelType { void 0 }
set C_modelArgList {
	{ rk int 8 regular {array 224 { 0 3 } 0 1 }  }
	{ skey int 8 regular {array 32 { 1 1 } 1 1 } {global 0}  }
}
...
set portList { 
	...
	{ skey_address0 sc_out sc_lv 5 signal 1 } 
	{ skey_ce0 sc_out sc_logic 1 signal 1 } 
	{ skey_q0 sc_in sc_lv 8 signal 1 } 
	{ skey_address1 sc_out sc_lv 5 signal 1 } 
	{ skey_ce1 sc_out sc_logic 1 signal 1 } 
	{ skey_q1 sc_in sc_lv 8 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "skey_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "skey", "role": "address1" }} , 
 	{ "name": "skey_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "skey", "role": "ce1" }} , 
 	{ "name": "skey_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "skey", "role": "q1" }}  ]}
...
set Spec2ImplPortList { 
	...
	skey { ap_memory {  { skey_address0 mem_address 1 5 }  { skey_ce0 mem_ce 1 1 }  { skey_q0 in_data 0 8 }  { skey_address1 MemPortADDR2 1 5 }  { skey_ce1 MemPortCE2 1 1 }  { skey_q1 in_data 0 8 } } }
}
