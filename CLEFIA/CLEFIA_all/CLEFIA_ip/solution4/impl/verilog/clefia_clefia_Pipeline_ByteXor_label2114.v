...
module clefia_clefia_Pipeline_ByteXor_label2114 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
    ...
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            reuse_addr_reg_fu_48[63] <= 1'b1;
                        ...
                        reuse_addr_reg_fu_48[1 : 0] <= zext_ln121_279_fu_142_p1[1 : 0];
            reuse_addr_reg_fu_48[63 : 3] <= zext_ln121_279_fu_142_p1[63 : 3];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        rin_1_addr_reg_231[1 : 0] <= zext_ln121_279_fu_142_p1[1 : 0];
    end
end
...
assign add_ln124_fu_147_p2 = (idx97_i351_fu_56 + 2'd1);

assign addr_cmp_fu_156_p2 = ((reuse_addr_reg_fu_48 == zext_ln121_279_fu_142_p1) ? 1'b1 : 1'b0);
...
assign icmp_ln123_fu_167_p2 = ((idx97_i351_fu_56 == 2'd3) ? 1'b1 : 1'b0);

assign or_ln121_fu_123_p2 = (or_ln3_fu_114_p4 | 8'd8);

assign or_ln3_fu_114_p4 = {{{r_1}, {1'd0}}, {idx97_i351_fu_56}};

assign reuse_select_fu_181_p3 = ((addr_cmp_reg_237[0:0] == 1'b1) ? reuse_reg_fu_52 : rin_1_q1);

assign rin_1_address0 = rin_1_addr_reg_231;

assign rin_1_address1 = zext_ln121_279_fu_142_p1;

assign rin_1_d0 = (rk_q0 ^ reuse_select_fu_181_p3);

assign rk_address0 = zext_ln121_fu_129_p1;

assign xor_ln124_98_fu_188_p2 = (rk_q0 ^ reuse_select_fu_181_p3);

assign zext_ln121_279_fu_142_p1 = zext_ln121_459_cast_fu_134_p3;

assign zext_ln121_459_cast_fu_134_p3 = {{1'd1}, {idx97_i351_fu_56}};

assign zext_ln121_fu_129_p1 = or_ln121_fu_123_p2;

always @ (posedge ap_clk) begin
    rin_1_addr_reg_231[3:2] <= 2'b01;
    reuse_addr_reg_fu_48[2] <= 1'b1;
end

endmodule //clefia_clefia_Pipeline_ByteXor_label2114
