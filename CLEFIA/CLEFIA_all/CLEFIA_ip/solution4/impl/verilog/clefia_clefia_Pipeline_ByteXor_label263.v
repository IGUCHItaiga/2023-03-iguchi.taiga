...
module clefia_clefia_Pipeline_ByteXor_label263 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln121_17_fu_98_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln121_fu_111_p1;
reg   [63:0] reuse_addr_reg_fu_38;
wire    ap_loop_init;
reg   [7:0] reuse_reg_fu_42;
wire   [7:0] xor_ln124_45_fu_157_p2;
reg   [1:0] idx97_i_fu_46;
wire   [1:0] add_ln124_fu_116_p2;
wire   [2:0] zext_ln121_238_cast_fu_103_p3;
    ...
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            reuse_addr_reg_fu_38[63] <= 1'b1;
                        ...
                        reuse_addr_reg_fu_38[1 : 0] <= zext_ln121_fu_111_p1[1 : 0];
            reuse_addr_reg_fu_38[63 : 3] <= zext_ln121_fu_111_p1[63 : 3];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        rin_addr_reg_195[1 : 0] <= zext_ln121_fu_111_p1[1 : 0];
    end
end
...
assign add_ln124_fu_116_p2 = (idx97_i_fu_46 + 2'd1);

assign addr_cmp_fu_125_p2 = ((reuse_addr_reg_fu_38 == zext_ln121_fu_111_p1) ? 1'b1 : 1'b0);
...
assign icmp_ln123_fu_136_p2 = ((idx97_i_fu_46 == 2'd3) ? 1'b1 : 1'b0);

assign reuse_select_fu_150_p3 = ((addr_cmp_reg_201[0:0] == 1'b1) ? reuse_reg_fu_42 : rin_q1);

assign rin_address0 = rin_addr_reg_195;

assign rin_address1 = zext_ln121_fu_111_p1;

assign rin_d0 = (rk_q0 ^ reuse_select_fu_150_p3);

assign rk_address0 = zext_ln121_17_fu_98_p1;

assign xor_ln124_45_fu_157_p2 = (rk_q0 ^ reuse_select_fu_150_p3);

assign zext_ln121_17_fu_98_p1 = idx97_i_fu_46;

assign zext_ln121_238_cast_fu_103_p3 = {{1'd1}, {idx97_i_fu_46}};

assign zext_ln121_fu_111_p1 = zext_ln121_238_cast_fu_103_p3;
...
endmodule //clefia_clefia_Pipeline_ByteXor_label263
