...
module clefia_clefia_Pipeline_ByteXor_label264 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] zext_ln121_fu_106_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln121_274_fu_115_p1;
reg   [63:0] reuse_addr_reg_fu_38;
wire    ap_loop_init;
reg   [7:0] reuse_reg_fu_42;
wire   [7:0] xor_ln124_46_fu_161_p2;
reg   [1:0] idx101_i_fu_46;
wire   [1:0] add_ln124_fu_120_p2;
wire  signed [2:0] zext_ln121_239_cast_fu_98_p3;
wire  signed [3:0] sext_ln121_fu_111_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            idx101_i_fu_46 <= 2'd0;
        end else if (((icmp_ln123_fu_140_p2 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
    ...
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            reuse_addr_reg_fu_38[63] <= 1'b1;
                        ...
                        reuse_addr_reg_fu_38[1 : 0] <= zext_ln121_274_fu_115_p1[1 : 0];
            reuse_addr_reg_fu_38[63 : 4] <= zext_ln121_274_fu_115_p1[63 : 4];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        rin_addr_reg_199[1 : 0] <= zext_ln121_274_fu_115_p1[1 : 0];
    end
end

always @ (*) begin
    if (((icmp_ln123_fu_140_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln124_fu_120_p2 = (idx101_i_fu_46 + 2'd1);

assign addr_cmp_fu_129_p2 = ((reuse_addr_reg_fu_38 == zext_ln121_274_fu_115_p1) ? 1'b1 : 1'b0);
...
assign icmp_ln123_fu_140_p2 = ((idx101_i_fu_46 == 2'd3) ? 1'b1 : 1'b0);

assign reuse_select_fu_154_p3 = ((addr_cmp_reg_205[0:0] == 1'b1) ? reuse_reg_fu_42 : rin_q1);

assign rin_address0 = rin_addr_reg_199;

assign rin_address1 = zext_ln121_274_fu_115_p1;

assign rin_d0 = (rk_q0 ^ reuse_select_fu_154_p3);

assign rk_address0 = zext_ln121_fu_106_p1;

assign sext_ln121_fu_111_p1 = zext_ln121_239_cast_fu_98_p3;

assign xor_ln124_46_fu_161_p2 = (rk_q0 ^ reuse_select_fu_154_p3);

assign zext_ln121_239_cast_fu_98_p3 = {{1'd1}, {idx101_i_fu_46}};

assign zext_ln121_274_fu_115_p1 = $unsigned(sext_ln121_fu_111_p1);

assign zext_ln121_fu_106_p1 = $unsigned(zext_ln121_239_cast_fu_98_p3);
...
endmodule //clefia_clefia_Pipeline_ByteXor_label264
