...
entity clefia_clefia_Pipeline_ByteXor_label279 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of clefia_clefia_Pipeline_ByteXor_label279 is 
...
attribute shreg_extract : string;
    ...
    signal xor_ln124_75_fu_111_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal xor_ln124_75_reg_139 : STD_LOGIC_VECTOR (7 downto 0);
    signal zext_ln121_26_fu_86_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal zext_ln121_270_fu_101_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal idx_i2866_fu_32 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln124_fu_80_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_idx_i2866_load : STD_LOGIC_VECTOR (4 downto 0);
    signal zext_ln121_fu_91_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal add_ln121_116_fu_95_p2 : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    ...
    idx_i2866_fu_32_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln123_fu_74_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    ...
                    idx_i2866_fu_32 <= ap_const_lv5_0;
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ap_loop_exit_ready_pp0_iter1_reg <= ap_loop_exit_ready;
                    rk_addr_reg_133_pp0_iter1_reg(5 downto 0) <= rk_addr_reg_133(5 downto 0);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln123_fu_74_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    rk_addr_reg_133(5 downto 0) <= zext_ln121_270_fu_101_p1(8 - 1 downto 0)(5 downto 0);
            end if;
        end if;
    end process;
    rk_addr_reg_133(7 downto 6) <= "00";
    rk_addr_reg_133_pp0_iter1_reg(7 downto 6) <= "00";
    ...
    add_ln121_116_fu_95_p2 <= std_logic_vector(unsigned(zext_ln121_fu_91_p1) + unsigned(ap_const_lv6_18));
    add_ln124_fu_80_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_idx_i2866_load) + unsigned(ap_const_lv5_1));
    ...
    ap_sig_allocacmp_idx_i2866_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, idx_i2866_fu_32, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_idx_i2866_load <= ap_const_lv5_0;
        else 
            ap_sig_allocacmp_idx_i2866_load <= idx_i2866_fu_32;
        end if; 
    end process;

    icmp_ln123_fu_74_p2 <= "1" when (ap_sig_allocacmp_idx_i2866_load = ap_const_lv5_10) else "0";
    rk_address0 <= rk_addr_reg_133_pp0_iter1_reg;
    rk_address1 <= zext_ln121_270_fu_101_p1(8 - 1 downto 0);
    ...
    skey_address0 <= zext_ln121_26_fu_86_p1(5 - 1 downto 0);
    ...
    xor_ln124_75_fu_111_p2 <= (skey_q0 xor rk_q1);
    zext_ln121_26_fu_86_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_idx_i2866_load),64));
    zext_ln121_270_fu_101_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln121_116_fu_95_p2),64));
    zext_ln121_fu_91_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_idx_i2866_load),6));
end behav;
