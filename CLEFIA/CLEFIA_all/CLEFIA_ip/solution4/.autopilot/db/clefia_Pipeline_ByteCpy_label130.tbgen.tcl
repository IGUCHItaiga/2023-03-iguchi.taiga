set moduleName clefia_Pipeline_ByteCpy_label130
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {clefia_Pipeline_ByteCpy_label130}
set C_modelType { void 0 }
set C_modelArgList {
	{ t int 8 regular {array 16 { 1 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	t { ap_memory {  { t_address0 mem_address 1 4 }  { t_ce0 mem_ce 1 1 }  { t_q0 in_data 0 8 } } }
