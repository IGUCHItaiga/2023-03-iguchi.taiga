set moduleName clefia_Pipeline_ByteCpy_label143
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {clefia_Pipeline_ByteCpy_label143}
set C_modelType { void 0 }
set C_modelArgList {
	{ t_5 int 8 regular {array 16 { 1 3 } 1 1 }  }
	{ lk int 8 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "t_5", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ t_5_address0 sc_out sc_lv 4 signal 0 } 
	{ t_5_ce0 sc_out sc_logic 1 signal 0 } 
	{ t_5_q0 sc_in sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "t_5_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "t_5", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	t_5 { ap_memory {  { t_5_address0 mem_address 1 4 }  { t_5_ce0 mem_ce 1 1 }  { t_5_q0 in_data 0 8 } } }
