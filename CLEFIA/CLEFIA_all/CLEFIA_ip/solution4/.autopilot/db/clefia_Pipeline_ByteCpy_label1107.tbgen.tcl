set moduleName clefia_Pipeline_ByteCpy_label1107
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {clefia_Pipeline_ByteCpy_label1107}
set C_modelType { void 0 }
set C_modelArgList {
	{ fin_6 int 8 regular {array 32 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "fin_6", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	fin_6 { ap_memory {  { fin_6_address0 mem_address 1 5 }  { fin_6_ce0 mem_ce 1 1 }  { fin_6_we0 mem_we 1 1 }  { fin_6_d0 mem_din 1 8 } } }
}
