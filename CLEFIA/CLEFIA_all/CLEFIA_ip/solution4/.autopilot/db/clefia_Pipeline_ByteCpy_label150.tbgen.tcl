set moduleName clefia_Pipeline_ByteCpy_label150
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {clefia_Pipeline_ByteCpy_label150}
set C_modelType { void 0 }
set C_modelArgList {
	{ t_8 int 8 regular {array 16 { 1 3 } 1 1 }  }
	{ lk int 8 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "t_8", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ t_8_address0 sc_out sc_lv 4 signal 0 } 
	{ t_8_ce0 sc_out sc_logic 1 signal 0 } 
	{ t_8_q0 sc_in sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "t_8_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "t_8", "role": "address0" }} , 
 	{ "name": "t_8_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "t_8", "role": "ce0" }} , 
 	{ "name": "t_8_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "t_8", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	t_8 { ap_memory {  { t_8_address0 mem_address 1 4 }  { t_8_ce0 mem_ce 1 1 }  { t_8_q0 in_data 0 8 } } }
