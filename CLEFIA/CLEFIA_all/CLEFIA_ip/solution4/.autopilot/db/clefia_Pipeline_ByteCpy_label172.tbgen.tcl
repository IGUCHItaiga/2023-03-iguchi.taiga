set moduleName clefia_Pipeline_ByteCpy_label172
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {clefia_Pipeline_ByteCpy_label172}
set C_modelType { void 0 }
set C_modelArgList {
	{ fin_4 int 8 regular {array 16 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "fin_4", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	fin_4 { ap_memory {  { fin_4_address0 mem_address 1 4 }  { fin_4_ce0 mem_ce 1 1 }  { fin_4_we0 mem_we 1 1 }  { fin_4_d0 mem_din 1 8 } } }
}
