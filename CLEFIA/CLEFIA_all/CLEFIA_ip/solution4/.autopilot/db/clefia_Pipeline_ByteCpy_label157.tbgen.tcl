set moduleName clefia_Pipeline_ByteCpy_label157
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {clefia_Pipeline_ByteCpy_label157}
set C_modelType { void 0 }
set C_modelArgList {
	{ fin_2 int 8 regular {array 32 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "fin_2", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	fin_2 { ap_memory {  { fin_2_address0 mem_address 1 5 }  { fin_2_ce0 mem_ce 1 1 }  { fin_2_we0 mem_we 1 1 }  { fin_2_d0 mem_din 1 8 } } }
}
