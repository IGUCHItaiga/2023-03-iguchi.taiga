set moduleName clefia_Pipeline_ByteXor_label234
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {clefia_Pipeline_ByteXor_label234}
set C_modelType { void 0 }
set C_modelArgList {
	{ lk int 8 regular {array 16 { 1 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	lk { ap_memory {  { lk_address0 mem_address 1 4 }  { lk_ce0 mem_ce 1 1 }  { lk_q0 in_data 0 8 } } }
