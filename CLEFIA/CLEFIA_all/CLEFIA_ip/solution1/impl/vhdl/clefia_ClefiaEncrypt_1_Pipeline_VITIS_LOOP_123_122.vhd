...
entity clefia_ClefiaEncrypt_1_Pipeline_VITIS_LOOP_123_122 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of clefia_ClefiaEncrypt_1_Pipeline_VITIS_LOOP_123_122 is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln121_121_fu_130_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln121_122_fu_141_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal indvars_iv2_fu_52 : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal zext_ln121_134_cast_fu_112_p3 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    ...
    indvars_iv2_fu_52_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                if ((icmp_ln123_fu_96_p2 = ap_const_lv1_0)) then 
                    indvars_iv2_fu_52 <= add_ln124_fu_102_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    indvars_iv2_fu_52 <= ap_const_lv3_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln123_fu_96_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start_int = ap_const_logic_1))) then
                    Clefia_enc_addr_reg_173(2 downto 0) <= zext_ln121_122_fu_141_p1(4 - 1 downto 0)(2 downto 0);
            end if;
        end if;
    end process;
    ...
    Clefia_enc_address0_assign_proc : process(ap_CS_fsm_state1, icmp_ln123_fu_96_p2, ap_CS_fsm_state2, Clefia_enc_addr_reg_173, zext_ln121_122_fu_141_p1)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            ...
            Clefia_enc_address0 <= zext_ln121_122_fu_141_p1(4 - 1 downto 0);
        else 
    ...
    add_ln124_fu_102_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvars_iv2_load) + unsigned(ap_const_lv3_1));
    ...
    ap_sig_allocacmp_indvars_iv2_load_assign_proc : process(ap_CS_fsm_state1, indvars_iv2_fu_52, ap_loop_init)
    begin
        if (((ap_loop_init = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_sig_allocacmp_indvars_iv2_load <= ap_const_lv3_0;
        else 
            ap_sig_allocacmp_indvars_iv2_load <= indvars_iv2_fu_52;
        end if; 
    end process;

    icmp_ln123_fu_96_p2 <= "1" when (ap_sig_allocacmp_indvars_iv2_load = ap_const_lv3_4) else "0";
    rk_address0 <= zext_ln121_121_fu_130_p1(8 - 1 downto 0);
    ...
    trunc_ln121_fu_108_p1 <= ap_sig_allocacmp_indvars_iv2_load(2 - 1 downto 0);
    xor_ln121_fu_135_p2 <= (ap_sig_allocacmp_indvars_iv2_load xor ap_const_lv3_4);
    zext_ln121_121_fu_130_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln121_fu_124_p2),64));
    zext_ln121_122_fu_141_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(xor_ln121_fu_135_p2),64));
    zext_ln121_134_cast_fu_112_p3 <= (ap_const_lv2_2 & trunc_ln121_fu_108_p1);
    zext_ln121_fu_120_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln121_134_cast_fu_112_p3),8));
end behav;
