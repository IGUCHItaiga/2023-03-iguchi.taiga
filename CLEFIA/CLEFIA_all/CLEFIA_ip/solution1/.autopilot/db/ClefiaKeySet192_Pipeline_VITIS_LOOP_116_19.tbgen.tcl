set moduleName ClefiaKeySet192_Pipeline_VITIS_LOOP_116_19
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {ClefiaKeySet192_Pipeline_VITIS_LOOP_116_19}
set C_modelType { void 0 }
set C_modelArgList {
	{ fout int 8 regular {array 32 { 1 3 } 1 1 }  }
	{ lk int 8 regular {array 32 { 0 3 } 0 1 }  }
}
...
set portList { 
	...
	{ fout_address0 sc_out sc_lv 5 signal 0 } 
...
set Spec2ImplPortList { 
	fout { ap_memory {  { fout_address0 mem_address 1 5 }  { fout_ce0 mem_ce 1 1 }  { fout_q0 in_data 0 8 } } }
	lk { ap_memory {  { lk_address0 mem_address 1 5 }  { lk_ce0 mem_ce 1 1 }  { lk_we0 mem_we 1 1 }  { lk_d0 mem_din 1 8 } } }
}
