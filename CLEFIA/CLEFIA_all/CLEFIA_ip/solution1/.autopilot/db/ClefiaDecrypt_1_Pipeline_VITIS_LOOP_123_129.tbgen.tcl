set moduleName ClefiaDecrypt_1_Pipeline_VITIS_LOOP_123_129
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {ClefiaDecrypt.1_Pipeline_VITIS_LOOP_123_129}
...
set portList { 
	...
	{ Clefia_dec_q0 sc_in sc_lv 8 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	Clefia_dec { ap_memory {  { Clefia_dec_address0 mem_address 1 4 }  { Clefia_dec_ce0 mem_ce 1 1 }  { Clefia_dec_we0 mem_we 1 1 }  { Clefia_dec_d0 mem_din 1 8 }  { Clefia_dec_q0 in_data 0 8 } } }
}
