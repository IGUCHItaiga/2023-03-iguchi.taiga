...
void ByteCpy(unsigned char *dst, const unsigned char *src, int bytelen)
{
  VITIS_LOOP_116_1: while(bytelen-- > 0){
    *dst++ = *src++;
  }
}
...
void ByteXor(unsigned char *dst, const unsigned char *a, const unsigned char *b, int bytelen)
{
  VITIS_LOOP_123_1: while(bytelen-- > 0){
    *dst++ = *a++ ^ *b++;
  }
}
...
void ClefiaKeySet128(unsigned char *rk, const unsigned char *skey)
{
  ...
  ByteCpy(rk, skey, 8);
  rk += 8;
  VITIS_LOOP_309_1: for(i = 0; i < 9; i++){
...
void ClefiaKeySet192(unsigned char *rk, const unsigned char *skey)
{
  ...
  VITIS_LOOP_329_1: for(i = 0; i < 8; i++){
    skey256[i + 24] = ~skey[i];
  }
  ...
  rk += 8;
  VITIS_LOOP_340_2: for(i = 0; i < 11; i++){
    if((i / 2) % 2){
...
void ClefiaKeySet256(unsigned char *rk, const unsigned char *skey)
{
  ...
  rk += 8;
  VITIS_LOOP_373_1: for(i = 0; i < 13; i++){
    if((i / 2) % 2){
...
{
  VITIS_LOOP_453_1: while(bytelen-- > 0){
    printf("%02x", *data++);
  }
  printf("\n");
}

__attribute__((sdx_kernel("clefia", 0))) void clefia(const unsigned char pt[16], int key_bitlen, const unsigned char Clefia_enc[16], const unsigned char Clefia_dec[16])
{
#line 10 "D:/tmp/CLEFIA_ip/solution1/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=Clefia_dec
# 460 "clefia.c"

#line 15 "D:/tmp/CLEFIA_ip/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=clefia
# 460 "clefia.c"

#line 6 "D:/tmp/CLEFIA_ip/solution1/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=return
# 460 "clefia.c"

#line 7 "D:/tmp/CLEFIA_ip/solution1/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=key_bitlen
# 460 "clefia.c"

#line 8 "D:/tmp/CLEFIA_ip/solution1/directives.tcl"
#pragma HLSDIRECTIVE INTERFACE s_axilite port=pt
# 460 "clefia.c"

#line 9 "D:/tmp/CLEFIA_ip/solution1/directives.tcl"
