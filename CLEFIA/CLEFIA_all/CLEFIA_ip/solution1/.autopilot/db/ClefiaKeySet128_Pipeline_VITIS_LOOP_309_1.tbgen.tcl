set moduleName ClefiaKeySet128_Pipeline_VITIS_LOOP_309_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {ClefiaKeySet128_Pipeline_VITIS_LOOP_309_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ lk int 8 regular {array 16 { 2 2 } 1 1 }  }
...
set Spec2ImplPortList { 
	lk { ap_memory {  { lk_address0 mem_address 1 4 }  { lk_ce0 mem_ce 1 1 }  { lk_we0 mem_we 1 1 }  { lk_d0 mem_din 1 8 }  { lk_q0 mem_dout 0 8 }  { lk_address1 MemPortADDR2 1 4 }  { lk_ce1 MemPortCE2 1 1 }  { lk_we1 MemPortWE2 1 1 }  { lk_d1 MemPortDIN2 1 8 }  { lk_q1 MemPortDOUT2 0 8 } } }
