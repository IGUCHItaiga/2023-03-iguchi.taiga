set moduleName clefia_Pipeline_VITIS_LOOP_116_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {clefia_Pipeline_VITIS_LOOP_116_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ ct int 8 regular {array 16 { 0 3 } 0 1 }  }
	{ Clefia_enc int 8 regular {array 16 { 1 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ct", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "Clefia_enc", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ Clefia_enc_q0 sc_in sc_lv 8 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	Clefia_enc { ap_memory {  { Clefia_enc_address0 mem_address 1 4 }  { Clefia_enc_ce0 mem_ce 1 1 }  { Clefia_enc_q0 in_data 0 8 } } }
}
