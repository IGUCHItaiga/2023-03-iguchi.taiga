...
set ID 3
set hasByteEnable 0
set MemName clefia_ClefiaF0Xor_2_clefia_s0_ROM_AUTO_1R
...
set ID 4
set hasByteEnable 0
set MemName clefia_ClefiaF0Xor_2_clefia_s1_ROM_AUTO_1R
set CoreName ap_simcore_mem
set PortList { 1 }
set DataWd 8
set AddrRange 256
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename dst \
    op interface \
    ports { dst_address0 { O 5 vector } dst_ce0 { O 1 bit } dst_we0 { O 1 bit } dst_d0 { O 8 vector } dst_address1 { O 5 vector } dst_ce1 { O 1 bit } dst_we1 { O 1 bit } dst_d1 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename src \
    op interface \
    ports { src_address0 { O 5 vector } src_ce0 { O 1 bit } src_q0 { I 8 vector } src_address1 { O 5 vector } src_ce1 { O 1 bit } src_q1 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename rk \
    op interface \
    ports { rk_address0 { O 9 vector } rk_ce0 { O 1 bit } rk_q0 { I 8 vector } } \
} "
} else {
