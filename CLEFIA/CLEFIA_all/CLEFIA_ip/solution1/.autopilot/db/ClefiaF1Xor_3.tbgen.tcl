...
set hasInterrupt 0
set C_modelName {ClefiaF1Xor.3}
set C_modelType { void 0 }
set C_modelArgList {
	{ dst int 8 regular {array 16 { 0 0 } 0 1 }  }
	{ src int 8 regular {array 16 { 1 1 } 1 1 }  }
...
set portList { 
	...
	{ dst_address1 sc_out sc_lv 4 signal 0 } 
	...
	{ src_address1 sc_out sc_lv 4 signal 1 } 
	{ src_ce1 sc_out sc_logic 1 signal 1 } 
	{ src_q1 sc_in sc_lv 8 signal 1 } 
	...
	{ rk_offset sc_in sc_lv 8 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "dst", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	dst { ap_memory {  { dst_address0 mem_address 1 4 }  { dst_ce0 mem_ce 1 1 }  { dst_we0 mem_we 1 1 }  { dst_d0 mem_din 1 8 }  { dst_address1 MemPortADDR2 1 4 }  { dst_ce1 MemPortCE2 1 1 }  { dst_we1 MemPortWE2 1 1 }  { dst_d1 MemPortDIN2 1 8 } } }
	src { ap_memory {  { src_address0 mem_address 1 4 }  { src_ce0 mem_ce 1 1 }  { src_q0 in_data 0 8 }  { src_address1 MemPortADDR2 1 4 }  { src_ce1 MemPortCE2 1 1 }  { src_q1 in_data 0 8 } } }
