...
entity clefia_ClefiaEncrypt_1_Pipeline_VITIS_LOOP_123_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of clefia_ClefiaEncrypt_1_Pipeline_VITIS_LOOP_123_1 is 
...
attribute shreg_extract : string;
    ...
    signal zext_ln121_124_fu_111_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal idx97_fu_46 : STD_LOGIC_VECTOR (1 downto 0);
    signal add_ln124_fu_116_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal zext_ln121_131_cast_fu_103_p3 : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    idx97_fu_46_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    idx97_fu_46 <= ap_const_lv2_0;
            ...
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    reuse_addr_reg_fu_38(63) <= '1';
                                        ...
                                        reuse_addr_reg_fu_38(1 downto 0) <= zext_ln121_124_fu_111_p1(1 downto 0);                    reuse_addr_reg_fu_38(63 downto 3) <= zext_ln121_124_fu_111_p1(63 downto 3);
                end if;
            end if; 
        end if;
    end process;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                addr_cmp_reg_201 <= addr_cmp_fu_125_p2;
                    rin_addr_reg_195(1 downto 0) <= zext_ln121_124_fu_111_p1(4 - 1 downto 0)(1 downto 0);
            end if;
        end if;
    end process;
    ...
    add_ln124_fu_116_p2 <= std_logic_vector(unsigned(idx97_fu_46) + unsigned(ap_const_lv2_1));
    addr_cmp_fu_125_p2 <= "1" when (reuse_addr_reg_fu_38 = zext_ln121_124_fu_111_p1) else "0";
    ...
    icmp_ln123_fu_136_p2 <= "1" when (idx97_fu_46 = ap_const_lv2_3) else "0";
    reuse_select_fu_150_p3 <= 
        reuse_reg_fu_42 when (addr_cmp_reg_201(0) = '1') else 
        rin_q1;
    rin_address0 <= rin_addr_reg_195;
    rin_address1 <= zext_ln121_124_fu_111_p1(4 - 1 downto 0);
    ...
    zext_ln121_124_fu_111_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(zext_ln121_131_cast_fu_103_p3),64));
    zext_ln121_131_cast_fu_103_p3 <= (ap_const_lv1_1 & idx97_fu_46);
    zext_ln121_fu_98_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(idx97_fu_46),64));
end behav;
